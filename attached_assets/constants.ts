...
import { CVJStage, CVJStageName, UnitType, Week, WeeklyDataEntry, Month, MonthlyKpiTarget, KPI } from './types';
...
export const INITIAL_CVJ_STAGES: CVJStage[] = [
    ...
    subCategories: [
      {
        ...
        displayOrder: 1,
        kpis: [
          { id: 'kpi_aware_new_visitors_ga4', name: 'Total New website Visitors (GA4)', description: 'The number of users who interacted with our site for the first time.', unitType: UnitType.NUMBER, defaultMonthlyTargetValue: 1701.6 * 4, isActive: true }, // Assuming target was weekly, now monthly
          { id: 'kpi_aware_active_visitors_ga4', name: 'Total active website Visitors (GA4)', description: 'The total number of active users.', unitType: UnitType.NUMBER, defaultMonthlyTargetValue: 1915.2 * 4, isActive: true },
          { id: 'kpi_aware_scp_views', name: 'Supply Chain Partners Views', description: 'Total number of views on all the Cesco pages including blogs, service pages and storefront.', unitType: UnitType.NUMBER, defaultMonthlyTargetValue: 1455.6 * 4, isActive: true },
          { id: 'kpi_aware_total_page_visits_sm', name: 'Total page visits (LI+FB+IG)', description: '', unitType: UnitType.NUMBER, defaultMonthlyTargetValue: 228.8 * 4, isActive: true },
      ...
      },
      {
        ...
        displayOrder: 3,
        kpis: [
          { id: 'kpi_aware_total_posts_sm', name: 'Total Number of Posts across SM channels (LI+FB+IG) incl stories', description: '', unitType: UnitType.NUMBER, defaultMonthlyTargetValue: 73.794 * 4, isActive: true },
        ],
      },
    ],
  },
    ...
    subCategories: [
      {
        ...
        displayOrder: 1,
        kpis: [
          { id: 'kpi_engage_total_content_interaction', name: 'Total Content Interaction (likes, shares, comments,saves, reposts, clicks and shares) (LI+FB+IG)', description: '', unitType: UnitType.NUMBER, defaultMonthlyTargetValue: 96.8 * 4, isActive: true },
          ...
          { id: 'kpi_engage_linkedin_newsletter_subs', name: 'LinkedIn Newsletters Subscribers', description: '', unitType: UnitType.NUMBER, defaultMonthlyTargetValue: 9.9 * 4, isActive: true },
        ],
      },
      {
        ...
        displayOrder: 2,
        kpis: [
          { id: 'kpi_engage_total_followers_sm', name: 'Total followers (LI+FB+IG [Follows-Unfollows])', description: '', unitType: UnitType.NUMBER, defaultMonthlyTargetValue: 53.9 * 4, isActive: true },
        ],
      },
      {
        ...
        displayOrder: 3,
        kpis: [
          { id: 'kpi_engage_avg_engagement_time_ga4', name: 'Average Engagment Time in seconds (GA4)', description: 'Average engagement time per active user for the time period selected.', unitType: UnitType.DURATION_SECONDS, defaultMonthlyTargetValue: 61.82, isActive: true }, // Averages might not sum monthly, keep as is or re-evaluate
      ...
      },
      {
        ...
        displayOrder: 5,
        kpis: [
          { id: 'kpi_engage_total_users_blogpost_ga4', name: 'Total Users on Blogpost (GA4)', description: 'Total views of people visited our blog pages.', unitType: UnitType.NUMBER, defaultMonthlyTargetValue: 19.8 * 4, isActive: true },
        ],
      },
    ],
  },
    ...
    subCategories: [
      {
        ...
        displayOrder: 1,
        kpis: [
          { id: 'kpi_subscribe_interpreting_forms_submitted', name: 'Interpreting forms Submitted', description: '', unitType: UnitType.NUMBER, defaultMonthlyTargetValue: 30.8 * 4, isActive: true },
          { id: 'kpi_subscribe_interpreting_forms_clicks', name: 'Interpreting forms Clicks', description: '', unitType: UnitType.NUMBER, defaultMonthlyTargetValue: 57.2 * 4, isActive: true },
          { id: 'kpi_subscribe_translation_forms_submitted', name: 'Translation forms Submitted', description: '', unitType: UnitType.NUMBER, defaultMonthlyTargetValue: 4.4 * 4, isActive: true },
          { id: 'kpi_subscribe_translation_forms_clicks', name: 'Translation forms Clicks', description: '', unitType: UnitType.NUMBER, defaultMonthlyTargetValue: 24.2 * 4, isActive: true },
        ],
      },
      {
        ...
        displayOrder: 2,
        kpis: [
          { id: 'kpi_subscribe_quote_requests_submitted', name: 'Quote Requests forms Submitted', description: '', unitType: UnitType.NUMBER, defaultMonthlyTargetValue: 14.3 * 4, isActive: true },
          { id: 'kpi_subscribe_quote_requests_clicks', name: 'Quote Requests forms Clicks', description: '', unitType: UnitType.NUMBER, defaultMonthlyTargetValue: 55 * 4, isActive: true },
        ],
      },
      {
  ...
  },
  {
    ...
    subCategories: [
       { id: 'excite_empty', name: 'Customer Satisfaction', displayOrder: 1, kpis: [{id: 'kpi_excite_nps', name: 'Net Promoter Score (NPS)', description: 'A measure of customer loyalty.', unitType: UnitType.NUMBER, defaultMonthlyTargetValue: 50, isActive: true}]}, // NPS is usually a snapshot, not summed
    ],
  },
  {
    id: 'ascend',
    ...
    subCategories: [
       { id: 'ascend_empty', name: 'Upsells & Cross-sells', displayOrder: 1, kpis: [{id: 'kpi_ascend_avg_order_value', name: 'Average Order Value (AOV)', description: 'Average amount spent per order.', unitType: UnitType.CURRENCY, defaultMonthlyTargetValue: 100, isActive: true}]}, // AOV is an average, not summed
    ],
  },
  {
    id: 'advocate',
...
// Generate default weeks with YYYY-MM-DD format
// Week 18: May 1st to May 7th (example, May 1 2024 is Wed, ISO week 18)
...
export const INITIAL_WEEKLY_DATA: WeeklyDataEntry[] = [
    // Data for Week 17 (mapped from original non-existent Week 19)
    ...
    // Data for Week 18 (mapped from original non-existent Week 20)
    ...
    // Data for Week 16 (mapped from original Week 18 to avoid collision and provide more sample variety)
...
export const INITIAL_MONTHLY_TARGETS: MonthlyKpiTarget[] = [
    { id: 'mt1', kpiId: 'kpi_aware_new_visitors_ga4', monthId: `${currentYear}-04`, targetValue: 6500 }, // April target
    { id: 'mt2', kpiId: 'kpi_aware_new_visitors_ga4', monthId: `${currentYear}-05`, targetValue: 7000 }, // May target
    ...
    { id: 'mt5', kpiId: 'kpi_aware_new_visitors_ga4', monthId: `${currentYear}-01`, targetValue: 4000 }, // For Week 4 (Jan)
    { id: 'mt6', kpiId: 'kpi_aware_new_visitors_ga4', monthId: `${currentYear}-02`, targetValue: 4200 }, // For Week 5 (Feb)
];

// Helper for creating week object from form data (used in App.tsx)
export const createWeekObjectFromFormData = (startDate: Date, endDate: Date): Week => {
    return createWeekFromDates(startDate, endDate);
};
export { getISOWeek, formatDateToYYYYMMDD, formatDateToMMDD };
